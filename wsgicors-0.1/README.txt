...
You can also plug it into your wsgi pipeline via paste ini to let it
serve by waitress for instance:
...
As can bee seen in the example above, a policy needs to be created with

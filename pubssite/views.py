...
@view_config(route_name='citation_delete', request_method='DELETE',renderer='pubs_json', permission=('user','admin'))
...
@view_config(route_name='collection_delete', request_method='DELETE', renderer='pubs_json', permission=('user','admin'))
